# https://www.powershellgallery.com/packages/PSOneTools/2.4
...
@(
  ...
  },
  {
    Register-ArgumentCompleter -Native -CommandName winget -ScriptBlock {
      ...
      winget complete --word "$Local:word" --commandline "$Local:ast" --position $cursorPosition | ForEach-ObjectFast {
...
$ObsidianVault = "C:/Users/Fox/Documents/Obsidian Vault"
